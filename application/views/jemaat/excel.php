...
class Excel{
    ...
    $excel->writelabel(0, 1, "member_key");
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->member_key);
        ...
        $excel->writelabel($i, 16,$row->gender_key);
        $excel->writelabel($i, 17,$row->pstatus_key);
        $excel->writelabel($i, 18,$row->pob);
        $excel->writelabel($i, 19,$row->blood_key);
        $excel->writelabel($i, 20,$row->kebaktian_key);
        $excel->writelabel($i, 21,$row->persekutuan_key);
        $excel->writelabel($i, 22,$row->rayon_key);
        $excel->writelabel($i, 23,$row->status_key);
